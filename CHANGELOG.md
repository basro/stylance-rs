...
- Added CI generated binaries for stylance-cli [#40](https://github.com/basro/stylance-rs/pull/40)
...
- Added hash_root_path configuration setting [#32](https://github.com/basro/stylance-rs/pull/32)
- Added support workspace config inheritance [#33](https://github.com/basro/stylance-rs/pull/33)
- Added support for passing more than one crate path to stylance cli [#30](https://github.com/basro/stylance-rs/pull/30)
- Changed how relative paths are computed to allow importing paths outside of the `hash_root_path`.

## 0.7.4

- Fixes stylance-cli watch mode Cargo.toml infinite loop on linux (v0.7.3 failed to address the problem for the Cargo.toml file watching). [#25](https://github.com/basro/stylance-rs/issues/25)

## 0.7.3

- Fix bug introduced on v0.7.2 where stylance-cli watch mode would enter an infinite loop on linux systems. [#25](https://github.com/basro/stylance-rs/issues/25)
